...
assign data_out_x = x_reg;   // downward propagation
assign data_out_y = y_reg;   // rightward propagation (R off-diagonal)
...
always @(*) begin
    ...
    case (current_state)
        ...
        SCALE: begin
            ...
            y_reg_next = $signed(y_reg * K) >>> K_FRAC; // 縮放係數運算，結果會留存至 IDLE 狀態輸出
        end
    endcase
end
